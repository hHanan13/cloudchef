                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-12 col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="card-icon">
                                        <img src="{{ asset('assets/front/images/icons/Group 201.png') }}" class="img-fluid" width="35px">
                                    </div>
                                <h4 class="card-title">users<span>   (88)</span> </h4>
                                </div>
                                <div class="col-xl-6 col-md-6 col-6">
                                    ...
                                    <div class="col-xl-5 col-12">
                                        <div class="row">
                                            <div class="col-xl-12 col-12">
                                                 <h4 class="card-title date date1">position <span style="margin-left: 5px;"> <select class="form-control date date1" id="GenderId" name="GenderId" placeholder="All">
                                                                <option value="1">one</option>
                                                                <option value="2">two</option>
                                                                <option value="3">three</option>
                                                        </select></span> <span style="margin-left: 5px;"> <img src="{{ asset('assets/front/images/icons/Group 68.png') }}" class="img-fluid btn date" width="35px" style="cursor: pointer;padding: 0px;"></span></h4>
                                            </div>
