            ...
            <div class="col-md-8 col-lg-9">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="seller-card">
                            <div class="seller-back">
                                <img src="{{asset('assets/front/images/Rectangle 91.png')}}" class="seller-background img-fluid" alt="">
                                <img src="{{asset('assets/front/images/c3.jpg')}}" class="seller-img img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="seller-card">
                            <div class="seller-back">
                                <img src="{{asset('assets/front/images/Rectangle 921.png')}}" class="seller-background" alt="">
                                <img src="{{asset('assets/front/images/istockphoto-1029922062-612x612.png')}}" class="seller-img" alt="">
                            </div>
                            <div class="seller-data">
                                <div class="seller-name">
                                    <h3>فهد ال راجح</h3>
