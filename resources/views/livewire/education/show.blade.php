                        ...
                        <div class="card-body">
                            ...
                            <label for="Name" class="bmd-label-floating">@lang('lang.ar.description')</label>
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <textarea id="w3review" class="form-control" name="description" rows="4" cols="50"
                                              wire:model.defer="description_ar" readonly>
                                         </textarea>
                                ...
                                <div class="col-xl-12">
                                 ...
                                 <textarea id="w3review" class="form-control" name="description" rows="4" cols="50"
                                           wire:model.defer="description_en" readonly>
                                         </textarea>
