            ...
            <div class="card-header card-header-primary card-header-icon">
               <div class="row">
                  <div class="col-md-6 col-sm-12">
                     ...
                     <h4 class="card-title">@lang('lang.education')
               ...
               @foreach($data['education']  as $education)
                            <tr>
                                ...
                                <td><span><img
                                            ...
                                            wire:click="activateEducation({{$education->id}})" {{$education->status == true ? 'checked' : ' '}}>
                                ...
                                <td class="text-right">
                                    ...
                                    <a onclick="confirm('Are you sure?') || event.stopImmediatePropagation()"
                                       wire:click="destroy({{$education->id}})" class="btn" style="padding: 5px;"><i
                                            class="material-icons"><img
