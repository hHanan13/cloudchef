                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="form-group bmd-form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <textarea   readonly id="w3review" class="form-control" name="description"  wire:model.defer="description_ar">
                                         </textarea>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group bmd-form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                   <textarea  readonly id="w3review" class="form-control" name="description"  wire:model.defer="description_en">
                                         </textarea>
