...
<<<<<<< HEAD:resources/views/livewire/contact/contactlive.blade.php
        <table class="table table-striped" style="margin-top:20px;">
=======

        <table class="table table-striped" style="margin-top:20px;background-color:#0f0;">
>>>>>>> master:resources/views/livewire/contactlive.blade.php
            <tr>
                <td>NO</td>
                <td>NAME</td>
                <td>EMAIL</td>
