...
<!-- Modal -->
<div  class="modal" role="dialog" data-backdrop="true" style="display: block">    <div class="modal-dialog" role="document">
                        ...
                        <div class="card-header card-header-rose card-header-icon">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-3">
                                    <button type="button" class="btn btn-fill close" data-dismiss="modal"   wire:click="toggleAddModal" aria-label="Close"
