                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input class="form-control"
                                                       ...
                                                       spellcheck="false"
                                                       data-ms-editor="true"
                                                       wire:model.defer="name_ar" readonly>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="form-group bmd-form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                             <textarea id="w3review"   readonly class="form-control" name="description" wire:model.defer="description_ar" >
                                         </textarea>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group bmd-form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                               <textarea id="w3review"   readonly class="form-control" name="description"  wire:model.defer="description_en" >
                                         </textarea>
