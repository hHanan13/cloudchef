<a data-toggle="modal" data-target="#updateModal" wire:click="edit({{$row->id}})" title="Click to edit" class="btn"
   style="padding:0;"> <i
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group bmd-form-group">
                                        <label for="exampleInputPassword1">@lang('lang.value_offer')</label>
                                        <input type="text" wire:model.defer="value_offer"
                                               class="form-control input-sm" placeholder="value_offer">
                                        <span
                                            class="text-danger"> @error('value_offer') {{$message}} @enderror </span>
