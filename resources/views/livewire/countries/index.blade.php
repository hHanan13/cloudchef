            ...
            <div class="card-header card-header-primary card-header-icon">
               <div class="row">
                  <div class="col-md-6 col-sm-12">
                     ...
                     <h4 class="card-title">@lang('lang.countries')
               ...
               @foreach($data['countries']  as $country)
                  ...
                  <td><input type="checkbox"
                            ...
                            <a><label class="switch tog">
                                    ...
                                    wire:click="activateCountry({{$country->id}})" {{$country->status == true ? 'checked' : ' '}}>
                            ...
                            <td class="text-right">
                                ...
                                @can('delete_countries')
                                    <a onclick="confirm('Are you sure?') || event.stopImmediatePropagation()"
                                       wire:click="destroy({{$country->id}})" class="btn" style="padding: 5px;"><i
                                            class="material-icons"><img
