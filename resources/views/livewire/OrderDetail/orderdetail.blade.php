<div>
    <section class="roles responsive_padding">
                                ...
                                <div class="col-xl-12 col-md-12 col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-md-8 col-12">
                                            ...
                                            <h4 class="card-title">@lang('lang.orderdetail') ()
                                                <span> </span>
                                            </h4>
                                        </div>
                                ...
                                <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                    ...
                                    @if($data !== 'null' && count($data )>0)
                                        <tr>
                                            ...
                                            <td>@lang('lang.NO')</td>
                                            <td>@lang('lang.PRODUCT')</td>
                                            <td>@lang('lang.TOTAL')</td>
                                            <td>@lang('lang.SUBTOTAL')</td>
                                            <td>@lang('lang.PAYMENT METHOD')</td>
                                            <td>@lang('lang.SHIPPING')</td>
                                            <td>@lang('lang.PAID')</td>
                                            <td>@lang('lang.BATCH ID')</td>
                                    ...
                                    @foreach($data as $row)
                                            ...
                                            <tr>
                                                ...
                                                <td><a><label class="switch">
                                                                ...
                                                                wire:click="activateOrderdetail({{$row->id}})" {{$row->status == true ? 'checked' : ' '}}>
                                                                <span class="slider round"></span>
                                                                </label></a></td>
                                                <td>
                                                    <a wire:click="destroy({{$row->id}})" class="btn destroy"><img
